...
})(["display:flex;flex-direction:column;justify-content:space-between;position:sticky;bottom:0;", ""], _styles_mediaQueries__WEBPACK_IMPORTED_MODULE_6__["default"].tablet(_templateObject4()));
...
function (_Component) {
  ...
  function Emergency() {
    ...
    _this.priceBreakdown = react__WEBPACK_IMPORTED_MODULE_0___default.a.createRef();
    _this.state = {
      chatSupport: false,
      responseTime: 0,
      hours: 0,
  ...
  _createClass(Emergency, [{
    ...
    value: function componentDidMount() {
      ...
      this.priceBreakdown.addEventListener("sticky-change", function (event) {
...
//# sourceMappingURL=reaction-commerce-support-plans.js.b531f0a607662e1c77bd.hot-update.js.map