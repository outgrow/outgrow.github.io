...
})(["display:inline-block;margin:1.5rem 0;position:relative;", " transform:translateX(-50%);", " ", ""], function (props) {
  return !props.keepLeft && "left: 50%;";
}, _styles_mediaQueries__WEBPACK_IMPORTED_MODULE_1__["default"].tablet(_templateObject(), function (props) {
  return !props.keepLeft && "left: 22rem;";
}), function (props) {
  return props.keepLeft && "left: -6rem";
}));

/***/ })

})
//# sourceMappingURL=reaction-commerce-support-plans.js.dbc4725821df34378c64.hot-update.js.map