...
function (_Component) {
  ...
  function Contact() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSubmit", function (event) {
      ...
      stitchClient.callFunction("sendContactRequest", [_this.state]).then(function (result) {
...
window.onLoad = function () {
  stitchClient = mongodb_stitch_browser_sdk__WEBPACK_IMPORTED_MODULE_4__["Stitch"].initializeDefaultAppClient("outgrow-hunql");
...
//# sourceMappingURL=contact.js.de96a1ff4a677ed8f4cd.hot-update.js.map