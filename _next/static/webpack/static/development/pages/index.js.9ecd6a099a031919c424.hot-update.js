...
function (_Component) {
  ...
  function Home() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleAppear", function (category) {
      console.log(category + " entered viewport");
    });
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        onChange: function onChange() {
          return _this2.handleAppear("consulting");
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 20
        ...
        onChange: function onChange() {
          return _this2.handleAppear("training");
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 31
        ...
        onChange: function onChange() {
          return _this2.handleAppear("support");
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 42
...
//# sourceMappingURL=index.js.9ecd6a099a031919c424.hot-update.js.map