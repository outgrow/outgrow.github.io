...
})(["height:100vh;width:100vw;background-size:cover;background-position:50%;", " html.webplossless &{", "}"], function (props) {
  return props.backgroundColor && "background-color: rgb(".concat(props.backgroundColor, ");");
}, function (props) {
  return props.backgroundImage && "background-image: url(".concat(backgroundImage, ".webp);");
});
...
//# sourceMappingURL=ecommerce-consulting.js.93336e951aee394fe1f2.hot-update.js.map